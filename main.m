...
% 创建实例
reader = DataReader('data/nsh202403.xlsx', '传感器监测数据报表');
...
plotter = DataPlotter(    'FolderName', 'results/plots','ImageSize', [1000, 280],'AutoSetXlims', false,'AutoSetYlims', false,'Xlims', [datetime(2024, 03, 01), datetime(2024, 03, 31)], 'Ylims', [-0.04,0.06], 'YPrecision', '%.2f',     'DrawWarningLines', true);
% 创建控制器
